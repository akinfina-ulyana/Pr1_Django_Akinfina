...
urlpatterns = [
    ...
    # path("register/dealership_worker/", DealershipWorkerRegisterView.as_view(), name="register-dealership_worker"),
    # path("register/supplier_worker/", SupplierWorkerRegisterView.as_view(), name="register-supplier_worker"),
